...
var _Creatable = require('./components/Creatable');

var _Creatable2 = _interopRequireDefault(_Creatable);

var _Contributors = require('./components/Contributors');

var _Contributors2 = _interopRequireDefault(_Contributors);

var _GithubUsers = require('./components/GithubUsers');

var _GithubUsers2 = _interopRequireDefault(_GithubUsers);

var _CustomComponents = require('./components/CustomComponents');

var _CustomComponents2 = _interopRequireDefault(_CustomComponents);

var _CustomRender = require('./components/CustomRender');

var _CustomRender2 = _interopRequireDefault(_CustomRender);

var _Multiselect = require('./components/Multiselect');

var _Multiselect2 = _interopRequireDefault(_Multiselect);

var _NumericSelect = require('./components/NumericSelect');

var _NumericSelect2 = _interopRequireDefault(_NumericSelect);

var _BooleanSelect = require('./components/BooleanSelect');

var _BooleanSelect2 = _interopRequireDefault(_BooleanSelect);

var _Virtualized = require('./components/Virtualized');

var _Virtualized2 = _interopRequireDefault(_Virtualized);
...
_reactDom2.default.render(_jsx('div', {}, void 0, _jsx(_States2.default, {
	label: 'States',
	searchable: true
}), _jsx(_Multiselect2.default, {
	label: 'Multiselect'
}), _jsx(_Virtualized2.default, {
	label: 'Virtualized'
}), _jsx(_Contributors2.default, {
	label: 'Contributors (Async)'
}), _jsx(_GithubUsers2.default, {
	label: 'Github users (Async with fetch.js)'
}), _jsx(_NumericSelect2.default, {
	label: 'Numeric Values'
}), _jsx(_BooleanSelect2.default, {
	label: 'Boolean Values'
}), _jsx(_CustomRender2.default, {
	label: 'Custom Render Methods'
}), _jsx(_CustomComponents2.default, {
	label: 'Custom Placeholder, Option, Value, and Arrow Components'
}), _jsx(_Creatable2.default, {
...
var _ref4 = _jsx('span', {
	className: 'checkbox-label'
}, void 0, 'Only include matches from the start of the string');

var _ref5 = _jsx('div', {
	className: 'hint'
}, void 0, 'This example uses simple boolean values');
...
var ValuesAsBooleansField = _react2.default.createClass({
	...
	render: function render() {
		...
		}, void 0, this.props.label), _jsx(_reactSelect2.default, {
...
var _ref3 = _jsx('div', {
	className: 'hint'
}, void 0, 'This example implements custom label and value properties, async options and opens the github profiles in a new window when values are clicked');
...
var Contributors = _react2.default.createClass({
	...
	render: function render() {
		return _jsx('div', {
			...
			className: 'section-heading'
		}, void 0, this.props.label), _jsx(_reactSelect2.default.Async, {
			multi: this.state.multi,
			value: this.state.value,
			onChange: this.onChange,
...
var CreatableDemo = _react2.default.createClass({
	...
	render: function render() {
		...
		return _jsx('div', {
			...
			className: 'section-heading'
		}, void 0, this.props.label), _jsx(_reactSelect2.default.Creatable, {
			multi: multi,
			options: options,
			...
			className: 'hint'
		}, void 0, this.props.hint), _jsx('div', {
			className: 'checkbox-list'
		}, void 0, _jsx('label', {
			className: 'checkbox'
		}, void 0, _jsx('input', {
...
var _ref = _jsx('span', {}, void 0, '\u263A Select User');

var _ref2 = _jsx('div', {
	className: 'hint'
}, void 0, 'This example implements custom Option and Value components to render a Gravatar image for each user based on their email. It also demonstrates rendering HTML elements as the placeholder.');
...
var _ref = _jsx('div', {
	className: 'hint'
}, void 0, 'This demonstates custom render methods and links in disabled options');
...
var DisabledUpsellOptions = _react2.default.createClass({
	...
	renderOption: function renderOption(option) {
		return _jsx(_reactHighlightWords2.default, {
...
var _ref4 = _jsx('span', {
	className: 'checkbox-label'
}, void 0, 'Backspace Removes?');

var _ref5 = _jsx('div', {
	className: 'hint'
}, void 0, 'This example uses fetch.js for showing Async options with Promises');
...
var GithubUsers = _react2.default.createClass({
	...
	render: function render() {
		...
		return _jsx('div', {
			...
			className: 'section-heading'
		}, void 0, this.props.label), _jsx(AsyncComponent, {
			multi: this.state.multi,
			value: this.state.value,
			onChange: this.onChange,
...
var _ref = _jsx('span', {
	className: 'checkbox-label'
}, void 0, 'Disable the control');

var _ref2 = _jsx('span', {
	className: 'checkbox-label'
}, void 0, 'I don\'t like Chocolate (disabled the option)');
...
var _ref5 = _jsx('div', {
	className: 'hint'
}, void 0, 'This example uses simple numeric values');
...
var StatesField = _react2.default.createClass({
	...
	render: function render() {
		...
		return _jsx('div', {
			...
			className: 'section-heading'
		}, void 0, this.props.label), _react2.default.createElement(_reactSelect2.default, { ref: 'stateSelect', autofocus: true, options: options, simpleValue: true, clearable: this.state.clearable, name: 'selected-state', disabled: this.state.disabled, value: this.state.selectValue, onChange: this.updateValue, searchable: this.state.searchable }), _jsx('div', {
			style: { marginTop: 14 }
		}, void 0, _jsx('button', {
			type: 'button',
			onClick: this.focusStateSelect
		}, void 0, 'Focus Select'), _jsx('label', {
			className: 'checkbox',
			style: { marginLeft: 10 }
		}, void 0, _jsx('input', {
			type: 'checkbox',
...
var _ref = _jsx('h3', {
	className: 'section-heading'
}, void 0, 'Cities (Large Dataset)');

var _ref2 = _jsx('div', {
	className: 'hint'
}, void 0, 'Uses ', _jsx('a', {
	href: 'https://github.com/bvaughn/react-virtualized'
}, void 0, 'react-virtualized'), ' and ', _jsx('a', {
	href: 'https://github.com/bvaughn/react-virtualized-select/'
}, void 0, 'react-virtualized-select'), ' to display a list of the world\'s 1,000 largest cities.');
...
var CitiesField = _react2.default.createClass({
	...
	render: function render() {
		...
		return _jsx('div', {
			className: 'section'
		}, void 0, _ref, _react2.default.createElement(_reactVirtualizedSelect2.default, { ref: 'citySelect',
			options: options,
			simpleValue: true,
			clearable: true,
			name: 'select-city',
